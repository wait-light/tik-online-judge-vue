<template>
    ...
    >
            ...
            <el-table-column prop="inputDescrible" label=""></el-table-column>
            <el-table-column prop="outputDescrible" label=""></el-table-column>
...
<script>
    ...
    import ProblemAddOrUpdate
        from "@/components/backstage/problem/ProblemAddOrUpdate.vue";
    ...
    export default {
        ...
        methods: {
            ...
            async loadData() {
                ...
                let result =await getList("/executor/problem/list",this.pageInfo.page,this.pageInfo.pageSize);
                if(result.success){
