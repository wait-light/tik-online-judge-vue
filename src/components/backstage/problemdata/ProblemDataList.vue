<template>
    ...
    >
            ...
            <el-table-column prop="createUserId" label="数据提供者"></el-table-column>
    ...
    <el-dialog title="添加/修改" v-model="prepareEntity.open">
        <div class="dialog-message">
            <ProblemDataAddOrUpdate @reloadData="loadData" :entity="prepareEntity.entity"></ProblemDataAddOrUpdate>
        </div>
    </el-dialog>
    <el-pagination
...
<script>
    ...
    import ProblemDataAddOrUpdate
        from "@/components/backstage/problemdata/ProblemDataAddOrUpdate.vue";

    export default {
        components: {
            ProblemDataAddOrUpdate,
        },
        data() {
            return {
                table:[],
        ...
        methods: {
            ...
            async prepareDelete(entity) {
                let result = await deleteById("/executor/problem-data", entity.id);
                if (result.success) {
                    this.loadData();
                }
            },
            ...
            async loadData() {
                ...
                let result =await getList("/executor/problem-data/list",this.pageInfo.page,this.pageInfo.pageSize);
                if(result.success){
